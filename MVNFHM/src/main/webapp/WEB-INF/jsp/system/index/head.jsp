					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a onclick="editUserH();" style="cursor:pointer;"><i class="ace-icon fa fa-user"></i><%=Modify_information %></a><!-- editUserH()在 WebRoot\static\js\myjs\head.js中 -->
								</li>
								<!-- <li id="systemset">
								...
								<li class="divider"></li>
								<li>
									<a href="logout"><i class="ace-icon fa fa-power-off"></i><%=Log_out %></a>
								</li>
							</ul>
						</li>
