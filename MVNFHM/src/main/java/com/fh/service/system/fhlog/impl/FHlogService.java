...
/**
 * 说明： 操作日志记录 创建人：FH Q313596790 创建时间：2016-05-10
 * 
 * @version
 */
...
public class FHlogService implements FHlogManager {
	 ...
	 */
	@Override
	public void saveDeviceLog(String userid, String comment, String[] deviceids, String gatewayid, int cmdtype,
		...
		if (deviceids == null) {
			...
			if (gatewayid == null) {
				...
				for (long gateway : sets) {
					...
					// PageData result =
					// (PageData)dao.findForObject("LogMapper.getDeviceListString", pd);
